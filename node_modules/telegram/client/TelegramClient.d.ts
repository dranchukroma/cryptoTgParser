import { TelegramBaseClient, TelegramClientParams } from "telegram/client/telegramBaseClient";
import * as authMethods from "telegram/client/auth";
import * as downloadMethods from "telegram/client/downloads";
import * as parseMethods from "telegram/client/messageParse";
import * as messageMethods from "telegram/client/messages";
import * as uploadMethods from "telegram/client/uploads";
import * as chatMethods from "telegram/client/chats";
import * as dialogMethods from "telegram/client/dialogs";
import * as twoFA from "telegram/client/2fa";
import type { ButtonLike, Entity, EntityLike, MessageIDLike } from "telegram/define";
...
import { Album, AlbumEvent } from "telegram/events/Album";
...
import { inspect } from "telegram/inspect";
/**
...
export declare class TelegramClient extends TelegramBaseClient {
     ...
     * ```
     */
    inlineQuery(bot: EntityLike, query: string, entity?: Api.InputPeerSelf, offset?: string, geoPoint?: Api.TypeInputGeoPoint): Promise<import("telegram/tl/custom/inlineResults").InlineResults>;
    /**
     ...
     * ```
     */
    getMessages(entity: EntityLike | undefined, getMessagesParams?: Partial<messageMethods.IterMessagesParams>): Promise<import("telegram/Helpers").TotalList<Api.Message>>;
    /**
     ...
     * ```
     */
    getDialogs(params?: dialogMethods.IterDialogsParams): Promise<import("telegram/Helpers").TotalList<import("telegram/tl/custom/dialog").Dialog>>;
    /**
     ...
     * @return
     */
    getParticipants(entity: EntityLike, params?: chatMethods.IterParticipantsParams): Promise<import("telegram/Helpers").TotalList<Api.User>>;
    /**
