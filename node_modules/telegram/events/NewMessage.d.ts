import { DefaultEventInterface, EventBuilder, EventCommon } from "telegram/events/common";
...
export declare class NewMessage extends EventBuilder {
    ...
    filter(event: NewMessageEvent): EventCommon | import("telegram/events/common").EventCommonSender | undefined;
